...
var cartao = {
    ...
    trocar_senha: `A3():${espaco}${espaco}CLIENTE ENTROU EM CONTATO COM DUVIDA NA ALTERAÇÃO DA SENHA DA SUA MÍDIA, FEITO ACESSO REMOTO${espaco}FOI REALIZADO O PROCEDIMENTO DE ALTERAÇÃO DA SENHA.${espaco}FOI FEITO O TESTE NO PORTAL E-CAC E TUDO OK.${espaco}${espaco}SOLICITAÇÃO`,
