...
birdid = {
    emitirCelular: `BIRD ID: ${espaco}CLIENTE ORIENTADO PASSO A PASSO NO PROCESSO DE DEMISSÃO PELO CELULAR.${espaco}CLIENTE ORIENTADO SOBRE A IMPORTÂNCIA DA SENHA DO PORTAL.${espaco}CERTIFICADO EMITIDO SEM ERROS${espaco}CLIENTE ORIENTADO A FAZER O TESTE NO PORTAL E-CAC, TESTADO SEM ERROS.${espaco}SOLICITAÇÃO`,
