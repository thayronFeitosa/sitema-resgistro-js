...
birdid = {
    emitir: `BIRD ID: ${espaco}CLIENTE COM DÚVIDA PARA EMITIR O CERTIFICADO.${espaco}FOI FEITO O ACESSO REMOTO.${espaco}FOI REALIZADA A SINCRONIZAÇÃO DO DISPOSITIVO.${espaco}CERTIFICADO EMITIDO COM ÊXITO.${espaco}INFORMADO SOBRE A IMPORT NCIA DA SENHA DE ACESSO AO PORTAL.${espaco}TESTADO NO ECAC COM ÊXITO NA OPÇÃO EM NUVEM.${espaco}SOLICITAÇÃO: `,
